    ...
    <div class="bg-image" style="background-image: url('/assets/media/various/bg_side_overlay_header.jpg');">
        <div class="bg-primary-op">
            <div class="content-header">
                ...
                <!-- User Info -->
                <div class="ms-2">
                    <a class="text-white fw-semibold">{{ Auth::user()->name }}</a>
                    ...
                    <div class="block mb-0">
                        ...
                        <div class="block-content block-content-full">
                            <div class="row g-sm text-center mb-2">
                                ...
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark fw-semibold text-dark" data-toggle="layout"
                                        data-action="header_mode_fixed"
                                        href="javascript:void(0)">Fixed</a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark fw-semibold text-dark" data-toggle="layout"
                                        data-action="header_mode_static"
                        ...
                        <div class="block-content block-content-full">
                            <div class="row g-sm text-center">
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark fw-semibold text-dark" data-toggle="layout"
                                        data-action="content_layout_boxed"
                                        href="javascript:void(0)">Boxed</a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark fw-semibold text-dark" data-toggle="layout"
                                        data-action="content_layout_narrow"
                                        href="javascript:void(0)">Narrow</a>
                                </div>
                                <div class="col-12 mb-1">
                                    <a class="d-block py-3 bg-body-dark fw-semibold text-dark" data-toggle="layout"
                                        data-action="content_layout_full_width"
                        ...
                        {{-- <div class="block-content block-content-full border-top">
                            <a class="btn w-100 btn-alt-primary" href="{{ url('be_layout_api.html') }}">
                ...
                <div class="tab-pane pull-x fade fade-up" id="so-people" role="tabpanel"
                    ...
                    <div class="block mb-0">
                        ...
                        <div class="block-content">
                            <ul class="nav-items">
                                <li>
                                    <a class="d-flex py-2" href="{{ url('be_pages_generic_profile.html') }}">
                                        <div class="flex-shrink-0 mx-3 overlay-container">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('assets/media/avatars/avatar7.jpg') }}"
                                                alt="">
                                            <span
                                ...
                                <li>
                                    <a class="d-flex py-2" href="{{ url('be_pages_generic_profile.html') }}">
                                        <div class="flex-shrink-0 mx-3 overlay-container">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('assets/media/avatars/avatar14.jpg') }}"
                                                alt="">
                                            <span
                                                class="overlay-item item item-tiny item-circle border border-2 border-white bg-success"></span>
                                        </div>
                                ...
                                <li>
                                    <a class="d-flex py-2" href="{{ url('be_pages_generic_profile.html') }}">
                                        <div class="flex-shrink-0 mx-3 overlay-container">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('assets/media/avatars/avatar4.jpg') }}"
                                                alt="">
                                            <span
                                                class="overlay-item item item-tiny item-circle border border-2 border-white bg-success"></span>
                                        </div>
                            ...
                            <ul class="nav-items">
                                <li>
                                    <a class="d-flex py-2" href="{{ url('be_pages_generic_profile.html') }}">
                                        <div class="flex-shrink-0 mx-3 overlay-container">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('assets/media/avatars/avatar11.jpg') }}"
                                                alt="">
                                            <span
                            ...
                            <ul class="nav-items">
                                ...
                                <li>
                                    <a class="d-flex py-2" href="{{ url('be_pages_generic_profile.html') }}">
                                        <div class="flex-shrink-0 mx-3 overlay-container">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('assets/media/avatars/avatar3.jpg') }}"
                                                alt="">
                                            <span
                                                class="overlay-item item item-tiny item-circle border border-2 border-white bg-muted"></span>
                                        </div>
                                ...
                                <li>
                                    <a class="d-flex py-2" href="{{ url('be_pages_generic_profile.html') }}">
                                        <div class="flex-shrink-0 mx-3 overlay-container">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('assets/media/avatars/avatar6.jpg') }}"
                                                alt="">
                                            <span
                                                class="overlay-item item item-tiny item-circle border border-2 border-white bg-muted"></span>
                                        </div>
                                ...
                                <li>
                                    <a class="d-flex py-2" href="{{ url('be_pages_generic_profile.html') }}">
                                        <div class="flex-shrink-0 mx-3 overlay-container">
                                            <img class="img-avatar img-avatar48"
                                                src="{{ asset('assets/media/avatars/avatar13.jpg') }}"
                                                alt="">
                                            <span
                                                class="overlay-item item item-tiny item-circle border border-2 border-white bg-muted"></span>
                                        </div>
